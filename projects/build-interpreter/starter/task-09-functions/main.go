...
// FunctionObj wraps a user-defined function, capturing its closure environment.
...
// ReturnValue is a sentinel that carries a return value through the call stack.
...
// ============================================================
// Evaluator — literals + arithmetic + variables + conditionals + functions
// ============================================================
...
func main() {
	env := NewEnvironment()
	src := "let add = fn(a,b){ a+b }; add(3,4)"
